...
const iconMap: Record<string, React.ComponentType<{ size?: number; className?: string }>> = {
  ...
  "Windows Server & Hyper-V": Server, "Active Directory (AD DS)": Users, "Linux (Ubuntu/Debian)": Terminal,
  "TCP/IP": Network, "DNS": Globe, "DHCP": Network, "Cisco Networking": Route, "EVE-NG": Network,
  "SoftEther VPN / L2 Bridge": Network, "Cisco Firewall / ACLs": Shield, "Fortinet FortiGate (NGFW)": Shield,
